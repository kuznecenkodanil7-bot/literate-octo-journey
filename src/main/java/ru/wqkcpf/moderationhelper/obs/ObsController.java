...
public final class ObsController {
    ...
    private synchronized void request(String requestType) {
        try {
    ...
    private final class ObsListener implements WebSocket.Listener {
        ...
        void awaitHelloAndIdentify(WebSocket ws) throws Exception {
            ...
            if (!identified) {
                ModerationHelperClient.LOGGER.warn("OBS identify timeout. Requests may fail if OBS requires authentication.");
            }
        }
    }
